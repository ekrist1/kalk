    ...
    <div>
        <div id="content" class="px-6 pb-8 pt-20 md:pt-16 w-full max-w-lg mx-auto mt-4">
            ...
            <ul class="list-reset flex">
                <li class="mr-6">
                    <a class="text-green font-bold hover:text-green-darker border-b-4 border-green-dark" href="#vendor">Sammenlign</a>
                </li>
                <li class="mr-6">
                    <a class="text-green font-bold hover:text-green-darker border-b-4 border-green-dark" href="#prices">Spotpriser</a>
                </li>
            </ul>
