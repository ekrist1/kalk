...
@endif
@if($score == 2)
    <svg fill="#DE751F" height="48" viewBox="0 0 24 24" width="48" xmlns="http://www.w3.org/2000/svg">
...
@endif
@if($score == 3)
    <svg fill="#EF5753" height="48" viewBox="0 0 24 24" width="48" xmlns="http://www.w3.org/2000/svg">
        <path d="M0 0h24v24H0z" fill="none"/>
        <circle cx="15.5" cy="9.5" r="1.5"/>
        <circle cx="8.5" cy="9.5" r="1.5"/>
